...
def test_my_word_to_vec_transformer():
    ...
    expected_lineage_df = DataFrame([[numpy.array([0.0, 0.0, 0.0]), 0],
                                     [numpy.array([0.0, 0.0, 0.0]), 1],
                                     [numpy.array([0.0, 0.0, 0.0]), 2]],
                                    columns=['array', 'mlinspect_lineage_0_0'])
    pandas.testing.assert_series_equal(lineage_output["mlinspect_lineage_0_0"],
                                       expected_lineage_df["mlinspect_lineage_0_0"])
    ...
    pandas.testing.assert_series_equal(lineage_output["mlinspect_lineage_2_0"],
                                       expected_lineage_df["mlinspect_lineage_2_0"])
    assert expected_lineage_df.iloc[0, 0].shape == (3,)
