...
class MlinspectEstimatorTransformer(BaseEstimator):
    ...
    def __init__(self, transformer, code_reference: CodeReference, analyzers):
    ...
    def fit(self, X: list, y=None) -> 'MlinspectEstimatorTransformer':
        ...
        if self.call_function_info == ('sklearn.pipeline', 'Pipeline'):
            ...
            execute_analyzer_visits_df_input_np_output(operator_context, self.code_reference, X, X, self.analyzers,
                                                       code_reference_analyzer_output_map)
            pass
        ...
        print(code_reference_analyzer_output_map)
        return self
...
def execute_analyzer_visits_df_input_np_output(operator_context, code_reference, input_data, output_data, analyzers,
                                               code_reference_analyzer_output_map):
...
def store_analyzer_outputs(annotation_iterators, code_reference, return_value, analyzers,
    ...
    code_reference_analyzer_output_map[code_reference] = analyzer_outputs
