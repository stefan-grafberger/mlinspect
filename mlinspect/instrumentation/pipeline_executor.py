...
class PipelineExecutor:
    ...
    def run(self, notebook_path: str or None, python_path: str or None, python_code: str or None,
        ...
        check_inspections = [constraint.required_inspection for check in checks for constraint in check.constraints]
        ...
        check_to_results = {(check, evaluate_check(check, inspection_result)) for check in checks}
