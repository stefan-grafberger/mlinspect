...
print("Shape of data: {}, train: {} and test: {}".format(data.shape, train_data.shape, test_data.shape))
# Introduce explainability
explainer = shap.KernelExplainer(f, model, data.iloc[:50,:])
shap_values = explainer.shap_values(test_data.iloc[299,:], nsamples=500)
